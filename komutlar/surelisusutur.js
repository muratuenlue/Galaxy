...
module.exports.run = async (bot, message, args) => {
  ...
  if(tomute.hasPermission("VIEW_AUDIT_LOG")) return message.reply("Hata: Geçici olarak susturmaya çalıştığınız kişi yetkili veya bot'un yetkisi belirttiğiniz kişiyi geçici olarak susturmaya yetmiyor!");
